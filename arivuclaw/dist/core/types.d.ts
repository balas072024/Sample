...
export interface UserIdentity {
    id: string;
    displayName: string;
    channels: Map<ChannelType, string>;
    roles: UserRole[];
    createdAt: Date;
}
...
export type ChannelType = "whatsapp" | "telegram" | "discord" | "slack" | "signal" | "imessage" | "matrix" | "teams" | "line" | "irc" | "web" | "cli" | "api";
...
export type ToolPermission = "filesystem.read" | "filesystem.write" | "filesystem.delete" | "network.http" | "network.websocket" | "network.tcp" | "browser.navigate" | "browser.interact" | "code.execute" | "system.process" | "system.env" | "system.admin" | "system.clipboard" | "system.screenshot" | "system.audio" | "system.notifications" | "channel.send" | "memory.read" | "memory.write" | "schedule.create" | "schedule.delete" | "docker.manage" | "git.ops" | "database.query" | "email.send" | "image.process" | "pdf.process" | "translate.text" | "ocr.extract" | "tts.speak" | "unrestricted";
