...
export class HealthDashboard {
  ...
  private requests: { duration: number; tokens: number; success: boolean; timestamp: number }[] = [];
  private maxHistory = 86400; // 24h of per-second data
  ...
  getHistogram(metric: "duration" | "tokens", minutes: number = 60): MetricPoint[] {
